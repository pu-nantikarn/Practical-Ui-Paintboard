...
// 📍 นำเข้า CSS ทั้งของ Generate (เพื่อเอาสไตล์ Popover) และ Image
...
const ImageSidebar = () => {
  ...
  // 📍 State ของ Palette พร้อมตัวแปรคุม Popover
  ...
  // ดักคลิกข้างนอกเพื่อปิด Popover
  useEffect(() => {
  ...
  // 📍 ฟังก์ชันดึงสีจากรูป แล้วใส่ในช่อง Palette ให้อัตโนมัติ!
